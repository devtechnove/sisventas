            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        {!! Form::text('name', $plan->name, ['class' => 'form-control', 'placeholder' => 'Nombre del plan']) !!}
                    </div>
                    @error('name')
                    ...
                    <div class="col-sm-6 mt-1">
                        ...
                        <select name="tipo_plan" id="tipo_plan" class="form-control">
                            ...
                            <option value="Indeterminado"  {{($plan->tipo_plan ==='Indeterminado') ? 'selected' : ''}}>Indeterminado</option>
                            <option value="Mensual"  {{($plan->tipo_plan ==='Mensual') ? 'selected' : ''}}>Mensual</option>
                            <option value="Anual"    {{($plan->tipo_plan ==='Anual') ? 'selected' : ''}}>Anual</option>
                        </select>
                    </div>
                    @error('tipo_plan')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="col-sm-6 mt-1">
                        ...
                        {!! Form::text('amount', $plan->amount, ['class' => 'form-control', 'placeholder' => 'Costo $']) !!}
                    </div>
                    @error('amount')
                        <span class="invalid-feedback" role="alert">
                        <small>{{ $message }}</small>
