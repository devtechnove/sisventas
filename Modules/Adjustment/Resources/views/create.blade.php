...
@section('title', 'ADJUSTE DE INVENTARIO')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('adjustments.index') }}">Ajuste de inventario</a></li>
                        ...
                        <form action="{{ route('adjustments.store') }}" method="POST">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Guardar ajuste <i class="bi bi-save"></i>
                                </button>
                            </div>
                        </form>
                    </div>
