...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('roles.index') }}">Listado general</a></li>
        <li class="breadcrumb-item active">Modificar Role:  <b>{{ $role->name }}</b></li>
    </ol>
@endsection
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_total_stats">Estadísticas</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="access_user_management">Acesso</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_own_profile">Modificar propio perfil</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_products">Ver</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="send_quotation_mails">Enviar por correo</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="access_expense_categories">Categoría de gastos</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="delete_customers" name="permissions[]"
                                                               value="delete_customers" {{ $role->hasPermissionTo('delete_customers') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_customers">Borrar</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="access_caja" name="permissions[]"
                                                               value="access_caja" {{ $role->hasPermissionTo('access_caja') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_caja">Acceso</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="create_caja" name="permissions[]"
                                                               value="create_caja" {{ $role->hasPermissionTo('create_caja') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_caja">Crear</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="edit_caja" name="permissions[]"
                                                               value="edit_caja" {{ $role->hasPermissionTo('edit_caja') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_caja">Editar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="delete_caja" name="permissions[]"
                                                               value="delete_caja" {{ $role->hasPermissionTo('delete_caja') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_caja">Eliminar</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="access_accounts" name="permissions[]"
                                                               value="access_accounts" {{ $role->hasPermissionTo('access_accounts') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_accounts">Acceso</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="create_accounts" name="permissions[]"
                                                               value="create_accounts" {{ $role->hasPermissionTo('create_accounts') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_accounts">Crear</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="edit_accounts" name="permissions[]"
                                                               value="edit_accounts" {{ $role->hasPermissionTo('edit_accounts') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_accounts">Editar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="delete_accounts" name="permissions[]"
                                                               value="delete_accounts" {{ $role->hasPermissionTo('delete_accounts') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_accounts">Eliminar</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="access_personal" name="permissions[]"
                                                               value="access_personal" {{ $role->hasPermissionTo('access_personal') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_personal">Acceso</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="create_personal" name="permissions[]"
                                                               value="create_personal" {{ $role->hasPermissionTo('create_personal') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_personal">Crear</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="edit_personal" name="permissions[]"
                                                               value="edit_personal" {{ $role->hasPermissionTo('edit_personal') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_personal">Editar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="delete_personal" name="permissions[]"
                                                               value="delete_personal" {{ $role->hasPermissionTo('delete_personal') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_personal">Eliminar</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="access_tarea" name="permissions[]"
                                                               value="access_tarea" {{ $role->hasPermissionTo('access_tarea') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_tarea">Acceso</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="create_tarea" name="permissions[]"
                                                               value="create_tarea" {{ $role->hasPermissionTo('create_tarea') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_tarea">Crear</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="edit_tarea" name="permissions[]"
                                                               value="edit_tarea" {{ $role->hasPermissionTo('edit_tarea') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_tarea">Editar</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="delete_tarea" name="permissions[]"
                                                               value="delete_tarea" {{ $role->hasPermissionTo('delete_tarea') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_tarea">Eliminar</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Guardar <i class="bi bi-save"></i>
                                </button>
                            </div>
                        </div>
                </form>
