    ...
    <div class="dropdown-menu">
        ...
        @can('access_sale_payments')
            @if($data->due_amount > 0)
                <a href="{{ route('sale-return-payments.create', $data->id) }}" class="dropdown-item">
                    <i class="bi bi-plus-circle-dotted mr-2 text-success" style="line-height: 1;"></i> Nuevo pago
                </a>
            @endif
        @endcan
        @can('edit_sales')
        ...
        @can('show_sales')
            <a href="{{ route('sale-returns.show', $data->id) }}" class="dropdown-item">
                <i class="bi bi-eye mr-2 text-info" style="line-height: 1;"></i> Ver detalles
            </a>
        @endcan
        @can('delete_sales')
