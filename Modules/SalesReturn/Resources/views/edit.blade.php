...
@section('title', 'Edición de devolución')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('sale-returns.index') }}">Devoluciones</a></li>
        <li class="breadcrumb-item active">Edición de devolución</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="sale-return-form" action="{{ route('sale-returns.update', $sale_return) }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">Monto cancelado <span class="text-danger">*</span></label>
