            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  ...
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{ App\Models\User::where('status',0)->count() }}</h4>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  ...
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{ App\Models\User::where('status',1)->count() }}</h4>
       ...
       <div class="row">
          <div class="col-sm-12 col-xl-12">
            <div class="row">
             <div class="col-sm-4">
                <div class="btn-group">
                <a class="btn btn-primary btn-md mb-4" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser" aria-controls="offcanvasAddUser"><span class="text-white">Nuevo usuario</span></a>
              </div>
             </div>
            </div>
            <div class="card">
