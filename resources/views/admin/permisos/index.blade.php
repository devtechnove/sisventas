 ...
 <div class="page-content">
  ...
  <ol class="breadcrumb breadcrumb-style1">
    ...
    <li class="breadcrumb-item">
     ...
     <li class="breadcrumb-item">
      <a href="javascript:void(0);"> <i class="fas fa-lock"></i> Permisos</a>
    </li>
              ...
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  ...
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{\Spatie\Permission\Models\Permission::count() }}</h4>
                   {{--  <small class="text-success">(+29%)</small> --}}
                  </div>
                  <small>Total general de permisos</small>
                </div>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  <span>Permisos inactivos</span>
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{ \Spatie\Permission\Models\Permission::where('status',0)->count() }}</h4>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  ...
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{ \Spatie\Permission\Models\Permission::where('status',1)->count() }}</h4>
       ...
       <div class="row">
          <div class="col-sm-12 col-xl-12">
            <div class="row">
             <div class="col-sm-4">
                <div class="btn-group">
                <a class="btn btn-primary btn-md mb-4" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser" aria-controls="offcanvasAddUser"><span class="text-white">Nuevo permiso</span></a>
              </div>
             </div>
            </div>
            <div class="card">
  ...
  @include('admin.permisos.partials.modal.create')
  @include('admin.permisos.partials.modal.edit')  
