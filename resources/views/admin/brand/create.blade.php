...
<div class="page-content">
  ...
  <ol class="breadcrumb breadcrumb-style1">
    ...
    <li class="breadcrumb-item">
      <a href="javascript:void(0);"> <i class="fas fa-credit-card"></i> Punto de venta</a>
    </li>
     <li class="breadcrumb-item">
      <a href="javascript:void(0);"> <i class="fab fa-apple"></i> Marcas</a>
    </li>
    <li class="breadcrumb-item active">Listado general de marcas</li>
  </ol>
 </nav>
 <div class="row g-4 mb-4">
              ...
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  ...
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{\App\Models\Marca::count() }}</h4>
                   {{--  <small class="text-success">(+29%)</small> --}}
                  </div>
                  <small>Total general de marcas</small>
                </div>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  <span>Marcas inactivas</span>
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{ \App\Models\Marca::where('is_active',0)->count() }}</h4>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                  ...
                  <div class="d-flex align-items-end mt-2">
                    <h4 class="mb-0 me-2">{{ \App\Models\Marca::where('is_active',1)->count() }}</h4>
   ...
   <div class="col-sm-12 col-xl-12">
    <div class="btn-group">
        ...
        <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#createModal"><i class="mdi mdi-plus"></i> {{trans('file.Add Brand')}} </button>&nbsp;
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#importBrand"><span class="iconify" data-icon="mdi:upload"></span></i> {{trans('file.Import Brand')}}</button>
 
    </div>
      <div class="card mt-3">
        <div class="card-header">
          <div class="content-left">
              <b>Listado general de marcas</b>            
         </div>
        </div>
        <div class="card-body">
          <section>
        ...
        <table id="tableExport" class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$brand->id}}</td>
                    @if($brand->image)
                    <td> <img src="{{url('public/images/brand',$brand->image)}}" height="30" >
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
                    ...
                    <td>
                       <div class="btn-group">
                            <button type="button" data-id="{{$brand->id}}" class="open-EditbrandDialog btn btn-md btn-primary" data-bs-toggle="modal" data-bs-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button>

                        {{ Form::open(['route' => ['brand.destroy', $brand->id], 'method' => 'DELETE'] ) }}
                               
                                    <button type="submit" class="btn btn-md btn-danger" onclick="return confirm('Are you sure want to delete?')"><i class="dripicons-trash"></i> {{trans('file.delete')}}</button>
