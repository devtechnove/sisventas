...
<section class="forms">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                   <div class="form-password-toggle">
                                      ...
                                      <div class="input-group">
                                        <select name="warehouse_id" class="selectpicker form-control" id="selectFamiliaProducto"  title="Seleccione el almacén">
                                            @foreach($lims_almacen_list as $almacen)
                                                <option value="{{$almacen->id}}">{{$almacen->name}}</option>
                                            @endforeach
                                          </select>
                                        <a  class="btn  btn-outline-primary" data-bs-toggle="modal" data-bs-target="#formFamiliaProducto"><i class="zmdi zmdi-plus" ></i></a>
                                      </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                   <div class="form-password-toggle">
                                     <label><strong>{{trans('file.Brand')}}</strong> </label>
                                      <div class="input-group">
                                        <select name="warehouse_id" class="selectpicker form-control" id="selectMarcaProducto"  title="Seleccione el almacén">
                                            @foreach($lims_brand_list as $brand)
                                                <option value="{{$brand->id}}">{{$brand->title}}</option>
                                            @endforeach
                                          </select>
                                        <a  class="btn  btn-outline-primary" data-bs-toggle="modal" data-bs-target="#formMarca"><i class="zmdi zmdi-plus" ></i></a>
                                      </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="input-group">
                                          <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione la categoría">
                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        <div class="col-md-4 form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                  <select required  title="Presentación del producto" class="form-control selectpicker" name="unit_id">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label><strong>Cantidad inicial *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label><strong>{{trans('file.Tax Method')}}</strong> </label> <i class="fas fa-question" data-bs-toggle="tooltip" title="{{trans('file.Exclusive: Poduct price = Actual product price + Tax. Inclusive: Actual product price = Product price - Tax')}}"></i>
            ...
            {{-- @include('admin.product.partials.modal.almacen.create')
            @include('admin.product.partials.modal.marca.create') --}}
        </div>
...
<script>
      $(document).ready(function(){
       ...
       $('#main-form').submit(function(){
        ...
        if ($('#main-form #nameWithTitle').val() === '') {
            $('#main-form #nameWithTitle_alert').text('Ingrese el nombre correcto del almacén').show();
            $('#main-form #nameWithTitle').addClass('is-invalid');
            $('#main-form #nameWithTitle').focus();
            return false;
        }

         if ($('#main-form #addressWithTitle').val() === '') {
            $('#main-form #addressWithTitle_alert').text('Ingrese la dirección correcta del almacén').show();
            $('#main-form #addressWithTitle').addClass('is-invalid');
            $('#main-form #addressWithTitle').focus();
            return false;
        }

        if ($('#main-form #phoneWithTitle').val() === '') {
            $('#main-form #phoneWithTitle_alert').text('Ingrese el número telefónico del almacén').show();
            $('#main-form #phoneWithTitle').addClass('is-invalid');
            $('#main-form #phoneWithTitle').focus();
            return false;
        }
        ...
        var familiaProducto = $('#nameWithTitle').val();
