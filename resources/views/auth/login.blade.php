...
<!-- Register -->
      <div class="card">
        <div class="card-body">
          ...
          <p class="mb-4">Por favor ingresa los datos de tu cuenta.</p>
         ...
         <form id="main-form" class="mb-3" >
          ...
          <input type="hidden" id="_token" value="{{ csrf_token() }}">
            <div class="mb-3">
              <label for="email" class="form-label"><b>Correo electrónico o usuario</b></label>
              <input 
              id="email-username" 
              type="text" 
              class="form-control 
              ...
              autofocus >
             <span class="missing_alert text-danger" id="email-username_alert"></span>
            </div>
            ...
            <div class="mt-4">
            <button type="submit" class="btn btn-primary form-control ajax" >
                <i id="ajax-icon" class="fa fa-sign-in"></i> Ingresar
              </button>
            </div>
          </form>

          <div class="divider my-4 mt-4">
...
@section('scripts')
    ...
    <script src="/js/admin/auth/login.js"></script>
@endsection
