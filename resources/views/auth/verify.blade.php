...
<head>
    ...
    <title>DEVPOS | VERIFICACIÓN</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Verifique su dirección de correo electrónico. 🔒</h2>
                                <p class="card-text mb-2">Tienes poco tiempo para verificar tu correro electrónico.</p>
                                <div class="auth-forgot-password-form mt-2" action="page-auth-reset-password-v2.html" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                         <button type="submit" class="btn btn-primary mt-2">{{ __('Enviar nuevamente.') }}</button>.
                                ...
                                <p class="text-center mt-2"><a href="page-auth-login-v2.html"><i data-feather="chevron-left"></i> Atrás para iniciar sesión</a></p>
                            </div>
                        </div>
                        <!-- /Forgot password-->
                    </div>
