...
<head>
    ...
    <title>LARACONT | CONTRASEÑA</title>
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-2">Ingrese su correo electrónico y le enviaremos instrucciones para restablecer su contraseña
                                </p>
                                  @if (session('status'))
                               ...
                               <form lass="auth-forgot-password-form mt-2" method="POST" action="{{ route('password.email') }}">
                                  @csrf
                                    <div class="form-group">
                                       ...
                                       <input id="email" type="email" id="forgot-password-email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  placeholder="Ingresa el corre electrónico" autocomplete="email" autofocus>
                                ...
                                <p class="text-center mt-2">
                                    <a href="{{ route('login') }}"> <i data-feather="chevron-left"></i> Iniciar sesión </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password v1 -->
