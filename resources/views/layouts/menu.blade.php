...
@can('access_caja')
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('index.contabilidad') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        <i class="c-sidebar-nav-icon bi bi-journal-bookmark" style="line-height: 1;"></i> Transacciones
    </a>
    <ul class="c-sidebar-nav-dropdown-items">
        @can('access_caja')
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('index.contabilidad') ? 'c-active' : '' }}" href="{{ route('index.contabilidad') }}">
                <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> Cajas
            </a>
        </li>
        @endcan
    </ul>
