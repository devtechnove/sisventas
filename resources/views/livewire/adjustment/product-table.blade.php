    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            ...
            <tr class="align-middle">
                ...
                <th class="align-middle">Cantidad disponible</th>
                            ...
                            @if(isset($product['type']))
                                @if($product['type'] == 'add')
                                    <select name="types[]" class="form-control">
                                        <option value="add" selected>(+) Aumento</option>
                                        <option value="sub">(-) Disminución</option>
                                    </select>
                                @elseif($product['type'] == 'sub')
                                    <select name="types[]" class="form-control">
                                        <option value="sub" selected>(-) Disminución</option>
                                        <option value="add">(+) Aumento</option>
                                    </select>
                                @endif
                            @else
                                <select name="types[]" class="form-control">
                ...
                <tr>
                    <td colspan="7" class="text-center">
                        <span class="text-danger">
                            Por favor busca & selecciona un producto!
                        </span>
                    </td>
                </tr>
            @endif
