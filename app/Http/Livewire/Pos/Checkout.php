...
class Checkout extends Component
{
    ...
    public function proceed() {
        if ($this->customer_id != null) {
            ...
            session()->flash('message', '¡Debes seleccionar a un cliente!');
        }
    }
    ...
    public function updateQuantity($row_id, $product_id) {
        ...
        $producto = \DB::table('products')->where('id',$product_id)->first();
        //dd($producto);
        ...
        else
        {
            if ($this->check_quantity[$product_id] < $this->quantity[$product_id]) {
                session()->flash('message', 'La cantidad de este producto no está disponible');
    ...
    public function setProductDiscount($row_id, $product_id) {
        ...
        session()->flash('discount_message' . $product_id, '¡Descuento agregado al producto!');
    }
